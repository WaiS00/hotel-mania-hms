  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <a href="backend/booking_history_backend.php?bookingId=<?php echo $product_array[$key]["bookingId"];?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
      </div>
    </div>
  </div>
</div>
